...
export const CustomerServiceBanner = () => (
  <div className="fixed top-4 right-6 z-50 text-right pointer-events-auto select-none">
    <div className="text-xs sm:text-sm text-gray-700 leading-tight">
      ...
      <span className="font-mono tracking-wider text-base sm:text-lg text-blue-900">072 800 2080</span>
      <div className="mt-1 flex justify-end gap-2">
        <a href="tel:0728002080" className="inline-flex items-center px-2 py-1 rounded bg-green-50 border border-green-200 text-green-800 text-xs font-medium hover:bg-green-100 transition" title="Call Now">
        ...
        <a href="https://wa.me/94728002080" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-2 py-1 rounded bg-green-50 border border-green-200 text-green-800 text-xs font-medium hover:bg-green-100 transition" title="WhatsApp Now">
